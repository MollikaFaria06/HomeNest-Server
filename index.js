...
async function run() {
  try {
    ...
    app.post('/properties', verifyToken, async (req, res) => {
      ...
      // Use Firebase token info for owner
      property.owner = {
        uid: req.user.uid,
    ...
    app.put("/properties/:id", verifyToken, async (req, res) => {
      ...
      try {
        ...
        await propertyCollection.updateOne({ _id: id }, { $set: updatedData });
    ...
    app.delete("/properties/:id", verifyToken, async (req, res) => {
      ...
      try {
        ...
        await propertyCollection.deleteOne({ _id: id });
    ...
    // Get Reviews submitted by logged-in user (Protected)
